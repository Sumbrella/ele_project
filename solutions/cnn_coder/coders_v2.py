...
class Encoder(keras.Model):
    def __init__(self,
        ...
        for i, filters in enumerate(blocks):
            ...
            setattr(self, "dropout" + str(i), layers.GaussianDropout(0.5))
    ...
    def __init__(self,
        ...
        for i, filters in enumerate(blocks):
            setattr(self, "de_conv_layer" + str(i), DeConvLayer(
                filters=filters, kernel_size=kernel_size, strides=strides, activation=activation, unpool_size=unpool_size,
            ))
            setattr(self, "dropout" + str(i), layers.GaussianDropout(0.5))
